...
WEIGHTS_PATHS = {
    "coco":"/home/sivakorn/Image_Cap/CLIP_prefix_caption/coco_train/coco_prefix_latest.pt",
...
class ClipCaptionModel(nn.Module):
    ...
    def __init__(self, prefix_length: int, prefix_size: int = 512):
        ...
        self.gpt = AutoModelForCausalLM.from_pretrained('flax-community/gpt2-base-thai')
...
if __name__ == '__main__':
    ...
    # Create new dataset bactch for prediction
    FoodImageFolder = "../test/test/food/"
    FoodImageFolder_LIST = [FoodImageFolder + file for file in os.listdir(FoodImageFolder)]
    sampleImagepath = FoodImageFolder_LIST[0]

    TravelImageFolder = "../test/test/travel/"

    #Set parameter model 
    #  1850  python train.py --only_prefix --data ./data/coco/oscar_split_ViT-B_32_train.pkl --out_dir ./coco_train/ 
    ...
    weights_path = "/home/sivakorn/Image_Cap/CLIP_prefix_caption/coco_train/coco_prefix_latest.pt"
    ...
    pil_image =  PIL.Image.open(sampleImagepath)    
